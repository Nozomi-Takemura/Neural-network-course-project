...
for k = [1,3,5,7,27]%k = 100 % k=5
        ...
        %cd '/home/nozomi/Documents/2017courses/DMNN/Ex/1/fig14/SCG5';
        %cd '/home/nozomi/Documents/2017courses/DMNN/Ex/1/fig14/LM5';
        %cd '/home/nozomi/Documents/2017courses/DMNN/Ex/1/fig14/BP5';
        ...
        %title(['QN: #input =' num2str(length(tr.trainInd)) ', #hidden units=' num2str(k) ', dimension = 5']);
        %title(['BP: #input =' num2str(length(tr.trainInd)) ', #hidden units=' num2str(k) ', dimension = 5']);
        %title(['SCG: #input =' num2str(length(tr.trainInd)) ', #hidden units=' num2str(k) ', dimension = 5']);
        %title(['LM: #input =' num2str(length(tr.trainInd)) ', #hidden units=' num2str(k) ', dimension = 5']);
        ...
        tr.stop
        aa = net(g(:,tr.testInd));
        (t(:,tr.testInd)' -aa')'*(t(:,tr.testInd)' -aa')/length(aa)
        %save('BP_N11_NH100.mat')
        %save('SCG_N11_NH100.mat')
        %save('LM_N11_NH100.mat')
        %save('LM_N11_NH100_THIS_IS_TRUE_ANOTHER_NH5.mat')
        %save('SCG_N11_NH100_THIS_IS_TRUE_ANOTHER_NH5.mat')
        %save('QN_N11_NH100_THIS_IS_TRUE_ANOTHER_NH5.mat')
        %save('BP_N11_NH100_THIS_IS_TRUE_ANOTHER_NH5.mat')
end        
