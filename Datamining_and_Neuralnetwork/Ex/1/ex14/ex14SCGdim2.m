...
for m = [30,150,450,1200]
    ...
    for k = [1,3,5,7]%k=3
        ...
        title(['Approximated function against sinc(r): scaled conjugate gradient with the number of traing data=' num2str(m) ', amount of noise = 0.1, number of hidden units=' num2str(k) ', dimension = 2']);
...
t = toc;
save('C:\Temp\fig14\SCG_dim2\stat.mat', 'matrix_sum')
save('C:\Temp\fig14\SCG_dim2\stat.mat', 't')
save('C:\Temp\fig14\SCG_dim2\stat.mat', 'seq')
save('C:\Temp\fig14\SCG_dim2\all.mat')