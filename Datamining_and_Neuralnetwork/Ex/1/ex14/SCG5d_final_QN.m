...
j = 0.2;
count_k = 0;
matrix_sum = zeros(3,9);
%cd C:\Temp\1221ex14\SCGdim5\obs20;
cd /home/nozomi/Documents/2017courses/DMNN/Ex/1/fig14/QN
%sec = cell(5,1);
 %m = 10; k = 1
%tic;
...
%Data Generation
    ...
    for k = [5,20,60]%k=
        ...
        hold off;
        saveas(h,sprintf('QN_data%i_noise02_huni_%i_reg000001_yhat_vs_sinc_1stvs2nd.png',m, k)); % will create FIG1, FIG2,...
        %hold off;
        %close;
        ...
        legend({'sinc(x)','Approximated function'});
        hold off;
        saveas(g,sprintf('QN_data%i_noise02_huni_%i_reg000001_yhat_vs_sinc_3rdvs4th.png',m, k)); % will create FIG1, FIG2,...
        %close;
        ...
        hold off;       
        saveas(t,sprintf('QN_data%i_noise02_huni_%i_reg000001_yhat_vs_sinc_5th_vs_res.png',m, k)); % will create FIG1, FIG2,...
        %close;
        ...
        save(sprintf('QN_ndata%i_nneurons%i_summary.mat',m, k), 'matrix_sum')
        save(sprintf('QN_ndata%i_nneurons%i_time.mat',m, k), 't')
        save(sprintf('QN_ndata%i_nneurons%i_storule.mat',m, k), 'seq')
    end
    %end
