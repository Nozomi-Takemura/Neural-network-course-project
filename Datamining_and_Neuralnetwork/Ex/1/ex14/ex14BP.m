...
for m = [30,150,450,1200]
    ...
    for k = [1,3,5,7]
     ...
     %plot(sinc(sqrt(x(tr.trainInd).^2)),train_yhat,'r*');
        ...
        title(['Approxmiated function against sinc(r): scaled conjugate gradient with ' 'the number of traing data=' num2str(m) ', amount of noise = 0.1, number of hidden units=' num2str(k)]);
...
t = toc;
save('C:\Temp\fig14\SCG\stat.mat', 'matrix')
save('C:\Temp\fig14\SCG\stat.mat', 't')
save('C:\Temp\fig14\SCG\stat.mat', 'seq')
save('C:\Temp\fig14\SCG\all.mat')
%%