...
for m = [30,150,450,1200]
    ...
    for k = [1,3,5,7]
     ...
     %plot(sinc(sqrt(x(tr.trainInd).^2)),train_yhat,'r*');
        ...
        title(['Approxmiated function against sinc(r): BFGS Quasi-Newton with the number of traing data=' num2str(m) ', amount of noise = 0.1, number of hidden units=' num2str(k) ', dimension = 1']);
...
t = toc;
save('C:\Temp\fig14\QN_dim1\stat.mat', 'matrix')
save('C:\Temp\fig14\QN_dim1\stat.mat', 't')
save('C:\Temp\fig14\QN_dim1\stat.mat', 'seq')
save('C:\Temp\fig14\QN_dim1\all.mat')
