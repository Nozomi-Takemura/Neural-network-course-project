...
%Data Generation
    ...
    for k = [5,20,60,100]%k=3
        ...
        legend({'sinc(x)','Approximated function'});
        hold off;
        saveas(g,sprintf('BP_data%i_noise02_huni_%i_reg000001_yhat_vs_sinc_3rdvs4th.png',m, k)); % will create FIG1, FIG2,...
        %close;
        ...
        hold off;       
        saveas(t,sprintf('BP_data%i_noise02_huni_%i_reg000001_yhat_vs_sinc_5th_vs_res.png',m, k)); % will create FIG1, FIG2,...
        %close;
        ...
        %test_ind = tr.testInd;
        t = toc;
        save(sprintf('BP_ndata%i_nneurons%i_summary.mat',m, k), 'matrix_sum')
        save(sprintf('BP_ndata%i_nneurons%i_time.mat',m, k), 't')
        save(sprintf('BP_ndata%i_nneurons%i_storule.mat',m, k), 'seq')
    end
    %end
